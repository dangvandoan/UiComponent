...
/**
 * Class Save
 * @package AHTUI\BurningLog\Controller\Adminhtml\Post
 */
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        $id = !empty($data['burning_id']) ? $data['burning_id'] : null;
        ...
        return $this->resultRedirectFactory->create()->setPath('burninglog/post/index');
    }
}